...
class TenantMigrationVersion {
    ...
    #[ORM\Column(type:"string", length:64)] private string $version;
    #[ORM\Column(type:"datetime_immutable")] private \DateTimeImmutable $appliedAt;
    public function __construct(Tenant $tenant, string $version){$this->tenant=$tenant; $this->version=$version; $this->appliedAt=new \DateTimeImmutable();}
}